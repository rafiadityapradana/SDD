    ...
    public static LocalDateTime convertToLocalDateTime(Date dateToConvert) {
     ...
     public ResponseEntity<Object> registerService(RegisterRequest req) throws Exception {
          ...
          try {
               ...
               creditCartEntity.setCartNumber(bCryptPasswordEncoder
               .encode(req.getCardNumber()));
               creditCartEntity.setCvv(bCryptPasswordEncoder
               .encode(req.getCardNumber()));

               creditCartEntity.setExpired(bCryptPasswordEncoder
               .encode(req.getExpiredDate()));
               ...
               // emailUtil.sendOtpEmail(customerEntity.getEmail(), otp);
     ...
     public ResponseEntity<Object> regenerateOtpService(RegenerateOtpRequest req) throws Exception {
          try {   
               ...
               emailUtil.sendOtpEmail("rafiadityapradana@gmmail.com", otp);
